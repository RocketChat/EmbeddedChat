  ...
  const options = useMemo(
    () => ({
      ...
      thread: {
        label: 'Threads',
        id: 'thread',
        onClick: () => setExclusiveState('showAllThreads'),
        iconName: 'thread',
        visible: true,
      },
      mentions: {
        label: 'Mentions',
        id: 'mention',
        onClick: () => setExclusiveState('showMentions'),
        iconName: 'at',
        visible: true,
      },
      starred: {
        ...
        id: 'starred',
        onClick: () => setExclusiveState('showStarred'),
        iconName: 'star',
        visible: true,
      },
      pinned: {
        ...
        id: 'pinned',
        onClick: () => setExclusiveState('showPinned'),
        iconName: 'pin',
        visible: true,
      },
      members: {
        label: 'Members',
        id: 'members',
        onClick: () => setExclusiveState('showMembers'),
        iconName: 'members',
      ...
      files: {
        label: 'Files',
        id: 'files',
        onClick: () => setExclusiveState('showAllFiles'),
        iconName: 'clip',
        visible: isUserAuthenticated,
      },
      search: {
        ...
        id: 'search',
        onClick: () => setExclusiveState('showSearch'),
        iconName: 'magnifier',
        visible: isUserAuthenticated,
      },
      rInfo: {
        ...
        id: 'rInfo',
        onClick: () => setExclusiveState('showChannelinfo'),
        iconName: 'info',
        visible: isUserAuthenticated,
      },
      logout: {
