...
const emojiList = [
  ...
  { shortname: 'stuck_out_tongue', emoji: '😛', aliases: ['tongue', 'playful'] },
  { shortname: 'stuck_out_tongue_winking_eye', emoji: '😜', aliases: ['wink', 'tongue'] },
  { shortname: 'stuck_out_tongue_closed_eyes', emoji: '😝', aliases: ['tongue', 'playful'] },
  { shortname: 'kissing', emoji: '😗', aliases: ['kiss'] },
  { shortname: 'kissing_smiling_eyes', emoji: '😙', aliases: ['kiss', 'happy'] },
  ...
  { shortname: 'thumbsdown', emoji: '👎', aliases: ['no', 'bad', 'disapprove'] },
  ...
  { shortname: 'ear_with_hearing_aid', emoji: '🦻', aliases: ['hearing', 'aid'] },
  ...
  { shortname: 'heart_exclamation', emoji: '❣️', aliases: ['love', 'exclamation'] },
  { shortname: 'two_hearts', emoji: '💕', aliases: ['love', 'two'] },
  { shortname: 'revolving_hearts', emoji: '💞', aliases: ['love', 'revolving'] },
  ...
  { shortname: 'heart_decoration', emoji: '💟', aliases: ['love', 'decoration'] },
  ...
  { shortname: 'wheel_of_dharma', emoji: '☸️', aliases: ['buddhism', 'dharma'] },
  ...
  { shortname: 'place_of_worship', emoji: '🛐', aliases: ['worship', 'religion'] },
  ...
  { shortname: 'radioactive', emoji: '☢️', aliases: ['nuclear', 'radioactive'] },
  ...
  { shortname: 'eight_pointed_black_star', emoji: '✴️', aliases: ['star', 'eight'] },
  ...
  { shortname: 'ideograph_advantage', emoji: '🉐', aliases: ['japanese', 'advantage'] },
  { shortname: 'secret', emoji: '㊙️', aliases: ['japanese', 'secret'] },
  { shortname: 'congratulations', emoji: '㊗️', aliases: ['japanese', 'congratulations'] },
  ...
  { shortname: 'exclamation', emoji: '❗', aliases: ['exclamation', 'warning'] },
  { shortname: 'grey_exclamation', emoji: '❕', aliases: ['exclamation', 'grey'] },
  ...
  { shortname: 'eight_spoked_asterisk', emoji: '✳️', aliases: ['asterisk', 'eight'] },
  { shortname: 'negative_squared_cross_mark', emoji: '❎', aliases: ['no', 'cross'] },
  { shortname: 'white_check_mark', emoji: '✅', aliases: ['yes', 'check'] },
  { shortname: 'diamond_shape_with_a_dot_inside', emoji: '💠', aliases: ['diamond', 'dot'] },
  { shortname: 'cyclone', emoji: '🌀', aliases: ['cyclone', 'spiral'] },
  { shortname: 'loop', emoji: '➿', aliases: ['loop', 'curly'] },
  { shortname: 'globe_with_meridians', emoji: '🌐', aliases: ['globe', 'world'] },
  { shortname: 'm', emoji: 'Ⓜ️', aliases: ['metro', 'm'] },
  { shortname: 'atm', emoji: '🏧', aliases: ['atm', 'cash'] },
  { shortname: 'sa', emoji: '🈂️', aliases: ['japanese', 'service'] },
  { shortname: 'passport_control', emoji: '🛂', aliases: ['passport', 'control'] },
  ...
  { shortname: 'wheelchair', emoji: '♿', aliases: ['wheelchair', 'accessibility'] },
  ...
  { shortname: 'put_litter_in_its_place', emoji: '🚮', aliases: ['litter', 'bin'] },
  { shortname: 'cinema', emoji: '🎦', aliases: ['cinema', 'movie'] },
  { shortname: 'signal_strength', emoji: '📶', aliases: ['signal', 'strength'] },
  ...
  { shortname: 'raised_hand_with_fingers_splayed', emoji: '🖐️', aliases: ['stop', 'hand'] },
  ...
  { shortname: 'index_pointing_at_the_viewer', emoji: '🫵', aliases: ['point', 'you'] },
  { shortname: 'palms_up_together', emoji: '🤲', aliases: ['prayer', 'hands'] },
  { shortname: 'back_of_hand', emoji: '🤚', aliases: ['back', 'hand'] },
  { shortname: 'hand_with_index_finger_and_thumb_crossed', emoji: '🤌', aliases: ['pinch', 'money'] },
  { shortname: 'index_pointing_up', emoji: '☝️', aliases: ['up', 'point'] },
  { shortname: 'index_pointing_at_the_viewer_dark_skin_tone', emoji: '🫵🏿', aliases: ['point', 'you', 'dark'] },
  { shortname: 'index_pointing_at_the_viewer_light_skin_tone', emoji: '🫵🏻', aliases: ['point', 'you', 'light'] },
  { shortname: 'index_pointing_at_the_viewer_medium_dark_skin_tone', emoji: '🫵🏾', aliases: ['point', 'you', 'medium_dark'] },
  { shortname: 'index_pointing_at_the_viewer_medium_light_skin_tone', emoji: '🫵🏼', aliases: ['point', 'you', 'medium_light'] },
  { shortname: 'index_pointing_at_the_viewer_medium_skin_tone', emoji: '🫵🏽', aliases: ['point', 'you', 'medium'] },
  { shortname: 'thumbs_up', emoji: '👍', aliases: ['yes', 'good', 'approve'] },
  { shortname: 'thumbs_down', emoji: '👎', aliases: ['no', 'bad', 'disapprove'] },
