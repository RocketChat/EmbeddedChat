...
export const bubbleStyles = ({ theme, colors }) => {
  const styles = {
    ...
    messageBody: css`
      ...
      border-radius: ${theme.radius} ${theme.radius}
        ${theme.radius} 0.2rem;
...
export const bubbleStylesMe = (customTheme) => {
  ...
  const styles = {
    ...
    messageBodyMe: css`
      ...
      border-radius: ${theme.radius} ${theme.radius} 0.2rem
        ${theme.radius};
      &:hover {
    ...
    lastSequentialMe: css`
      border-radius: ${theme.radius} 0.2rem ${theme.radius}
        ${theme.radius};
    `,
    sequentialMe: css`
      border-radius: ${theme.radius} 0.2rem 0.2rem
        ${theme.radius};
    `,
